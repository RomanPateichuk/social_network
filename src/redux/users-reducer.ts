...
type ActionsTypes = ToggleFollowingProgressActionType |
  ToggleIsFetchingActionType | SetTotalUsersCountActionType | SetCurrentPageActionType
  | SetUsersActionType | UnfollowSuccessActionType | FollowSuccessActionType
