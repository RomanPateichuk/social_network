...
const App: React.FC<PropsType> = (props) => {
  ...
  return (
    <Layout>
        ...
        <Layout style={{padding: '24px 0', background: colorBgContainer}}>
          <Sider style={{background: colorBgContainer}} width={200}>
            ...
            >
              ...
              <Menu.Item key={'chat'} icon={<SettingOutlined/>}>
          ...
          <Content style={{padding: '0 24px', minHeight: 280}}>
            <Routes>
              ...
              <Route path='/profile/:userId?'
                     element={< React.Suspense fallback={<div> Loading...</div>}><ProfileContainer/>
                     </React.Suspense>}/>
              <Route path='/dialogs' element={< React.Suspense fallback={<div> Loading...</div>}><DialogsContainer/>
              </React.Suspense>}/>
              ...
              <Route path='/chat' element={< React.Suspense fallback={<div> Loading...</div>}> <ChatPage/>
              </React.Suspense>}/>
      ...
      <Footer style={{textAlign: 'center'}}>React JS ©2023 Created by Samurai</Footer>
    </Layout>
